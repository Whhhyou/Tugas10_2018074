...
import com.example.tugas10_shared.databinding.ActivityMain5Binding;
...
//setup view binding
        ...
        if (session.isLoggedIn()) {
            Intent intent = new Intent(MainActivity5.this, MainActivity5.class);startActivity(intent);
            finish();
        }
        session = new SessionManager(getApplicationContext());
