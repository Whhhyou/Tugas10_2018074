...
import com.example.tugas10_shared.databinding.ActivityMain4Binding;
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    Intent a = new Intent(MainActivity4.this, com.example.tugas10_shared.MainActivity3.class);
                    startActivity(a);
